...
public class Mitrovice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                {
                    case 0: {
                        adapterPlaceCategories = new CustomListAdpter_CategoriesPlaces(Mitrovice.this, foodList);
                        listPlaces.setAdapter(adapterPlaceCategories);
                        break;
                    }
                    case 1: {
                        adapterPlaceCategories = new CustomListAdpter_CategoriesPlaces(Mitrovice.this, accomodationList);
                        listPlaces.setAdapter(adapterPlaceCategories);
                        break;
                    }
                    case 2: {
                        adapterPlaceCategories = new CustomListAdpter_CategoriesPlaces(Mitrovice.this, cultureList);
                        listPlaces.setAdapter(adapterPlaceCategories);
                        break;
                    }
                    case 3: {
                        adapterPlaceCategories = new CustomListAdpter_CategoriesPlaces(Mitrovice.this, nightlifeList);
                        listPlaces.setAdapter(adapterPlaceCategories);
                        break;
                    }
                    case 4: {
                        adapterPlaceCategories = new CustomListAdpter_CategoriesPlaces(Mitrovice.this, outdoorList);
                        listPlaces.setAdapter(adapterPlaceCategories);
                        break;
                    }
                }
    ...
    public void loadPlaces(){
        ...
        call.enqueue(new Callback<List<Place>>() {
            ...
            public void onFailure(Call<List<Place>> call, Throwable t) {
                Toast.makeText(Mitrovice.this,"Fail to load Places!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void CategoryLists(List<Place> places){
        ...
        {
            if(place.getCity().equals("Mitrovice")) {
    ...
    public void ItemClickShowDialog() {
        listPlaces.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Place place = foodList.get(position);

                AlertDialog.Builder builder=new AlertDialog.Builder(Mitrovice.this);
